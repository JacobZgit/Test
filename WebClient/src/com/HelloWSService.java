 ...
 * 
 */
@WebServiceClient(name = "HelloWSService", targetNamespace = "http://com/", wsdlLocation = "http://localhost:8080/WebApplication1/HelloWSService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSSERVICE_QNAME = new QName("http://com/", "HelloWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebApplication1/HelloWSService?wsdl");
    ...
    public HelloWS getHelloWSPort() {
        return super.getPort(new QName("http://com/", "HelloWSPort"), HelloWS.class);
    }
    ...
    public HelloWS getHelloWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://com/", "HelloWSPort"), HelloWS.class, features);
    }
